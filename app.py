...
N_FEATURES = 14   # AU1/AU4/AU6 (4 classes cada) + eye_openness + hr_bpm
...
class JanelaFeatures(BaseModel):
	# 150 instantes, 14 valores cada — já relativos à baseline pessoal de T1,
	# calculados no lado local (Edge) antes de chegarem aqui
